...
var commandSpecs = []commandSpec{
	...
	{Canonical: "session-prepare", RequiredFields: requiredFields(field("product_id"), field("work_id"), field("agent")), Optional: "task (bounded to 8192 bytes; a resume supplies none); agent is the active agent; deterministic refusals exit 2, other failures exit 1", Enums: "none"},
