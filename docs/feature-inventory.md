...
| 3.16a | Outcome contract (goal bound to delivery) | **Proposed, pending operator acceptance.** Three-part premise / required end-state / candidate set, approved at planning and verified at completion; a weaker delivered end-state fails. | [`workflows.md`](./workflows.md) §2.1a; CD-0012 |
