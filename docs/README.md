...
| [`agent-adapter-transport-contract.md`](./agent-adapter-transport-contract.md) | **Accepted TS6, amended by CD-0023:** one global `concord.ts` custom-tool module adapting the current nine-tool surface to the short-lived Go CLI; no plugin or MCP. |
...
| [`decisions/CD-0023-epic-agent-surface-and-ts9-exception.md`](./decisions/CD-0023-epic-agent-surface-and-ts9-exception.md) | **Accepted CD-0023:** Epic reachability ships as a fail-closed 3.0.0 agent-surface major under one narrow, explicit TS9 evidence exception. |
