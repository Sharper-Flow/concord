...
|---|---|---|
| [`workflow-engine.v1.json`](./workflow-engine.v1.json) | CD-0013 | 56 workflow-engine conformance scenarios; assertions target authoritative state, projections, events, typed errors, and effects. Validated by [`workflow-engine-scenarios.schema.json`](../contracts/workflow-engine-scenarios.schema.json). |
