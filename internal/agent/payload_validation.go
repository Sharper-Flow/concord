...
var operationPayloadSchemas = map[string]string{
	"concord_product_view.resolve": "product_context", "concord_product_view.snapshot": "product_snapshot", "concord_product_view.portfolio": "product_row_page",
	...
	"concord_work_trace.history": "work_event_page", "concord_work_trace.continuity": "continuity_snapshot", "concord_work_trace.relations": "work_relation_graph", "concord_knowledge.search": "knowledge_page", "concord_knowledge.resolve_note": "canonical_note_result",
	"concord_work_define.capture": "mutation_result", "concord_work_define.revise_intent": "mutation_result", "concord_work_epic.create": "mutation_result", "concord_work_epic.add_entry": "mutation_result", "concord_work_epic.remove_entry": "mutation_result", "concord_work_epic.reorder_entry": "mutation_result", "concord_work_epic.change_requiredness": "mutation_result", "concord_work_epic.revise_narrative": "mutation_result", "concord_work_epic.entries": "epic_entries_result", "concord_work_transition.lifecycle": "mutation_result", "concord_work_transition.workflow_action": "mutation_result",
