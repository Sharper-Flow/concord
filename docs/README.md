...
| [`law-coverage.v1.json`](./law-coverage.v1.json) | **Authorizing coverage record:** how each indexed law record is proved, by typed anchor rather than by repository path; an indexed record the manifest omits is a validator finding (CD-0047). Authored as per-record shards under `docs/knowledge/coverage/`; this file is the generated aggregate. |
