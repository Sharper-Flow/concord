...
DELETE FROM fold_guard;
	...
	{
		Version: 73,
		Name:    "repin_orphaned_workflow_definition_pins",
		SQL: `
-- CD-0112 changed the definition content while version 1 was still active.
-- Version 1 now retains the released definitions, and version 2 carries the
-- changed definitions. Repin only rows that match neither shipped version
-- AND whose current_step is a step of the version-2 definition for their
-- ref, so a row the current definition cannot place stays on its recorded
-- digest and keeps refusing verification by name. Valid historical pins
-- remain attached to their recorded definition.
INSERT OR IGNORE INTO fold_guard(active) VALUES(1);
UPDATE workflow_instances
SET definition_version = 2,
    definition_digest = CASE definition_ref
        WHEN 'workflow.implementation' THEN 'sha256:e16dfed665a50ece82f33040d2cb0e4a6abfd72dbc5b4743098eab22f0faab89'
        WHEN 'workflow.break_fix' THEN 'sha256:d7f8d8cc8b951e74751ddafe95c7b9c9d65e606cd73c41b2ceadd5fa2cdf29cb'
        WHEN 'workflow.research' THEN 'sha256:7a987b5e2cbc9bafd7a80e92345efa35b331ccaa533aefe4722024485be57e4a'
        WHEN 'workflow.architecture_spike' THEN 'sha256:7f7a7c0802daf0bed8e65744ef12480f14045f1d8c4048b80d35021448b83c07'
        WHEN 'workflow.ops_runbook' THEN 'sha256:4b19ba4c81ffcb1fef8f2da8b45c47c9a0121f9531dcffabdd15af25c5b82dab'
        WHEN 'workflow.static_analysis' THEN 'sha256:161b3b2b85d075b069cb6b9a9dda26cf226c82ba4e7ee5e7946a2792cd76ecac'
        WHEN 'workflow.generic_one_off' THEN 'sha256:273c82c0a0cf6c17d231f1be898ff74c6158f8036985cb3e1666b8f12c1b7895'
    END
WHERE definition_ref IN (
    'workflow.implementation', 'workflow.break_fix', 'workflow.research',
    'workflow.architecture_spike', 'workflow.ops_runbook',
    'workflow.static_analysis', 'workflow.generic_one_off'
)
AND current_step IN (
    'proposal', 'discovery', 'design', 'planning', 'execution', 'acceptance', 'release',
    'reproduce', 'diagnose', 'repair', 'verify', 'complete',
    'frame', 'investigate', 'findings', 'conclude',
    'research', 'options', 'poc_optional', 'decision_record', 'review',
    'plan', 'approval', 'execute', 'health', 'rollback_optional', 'cleanup',
    'scope', 'analyze', 'report',
    'define'
)
AND NOT (
    (definition_version = 1 AND definition_digest IN (
        'sha256:deaeec1077f5360b23b4c6ca78328d45a620668c503760855ec28e7bf6ecf155',
        'sha256:aefce865f350345dc41fc1e2e988e7d5e246fa7fd560335399cf8c826e4cc35a',
        'sha256:adeb334ee4eb08e1907b2f36c618d809675a81f325266733142e697a90c108b9',
        'sha256:0de0f3007629a509f8d6e289ce424f33aaaa9c160693a530898f6c039149a3fa',
        'sha256:d1218c37554f1412b55445b306d5141d11789c7ff78fe0a656f6d15959357ced',
        'sha256:d0bc28751b65cb1ae5a0dc31e8db177a6ffe4480f39725fb16e467d88ef4c038',
        'sha256:c2b8b4c8ef11b2de08912f7c82faa91dffe6a2fbe4ddcef924ff4b393da578b3'
    ))
    OR (definition_version = 2 AND definition_digest IN (
        'sha256:e16dfed665a50ece82f33040d2cb0e4a6abfd72dbc5b4743098eab22f0faab89',
        'sha256:d7f8d8cc8b951e74751ddafe95c7b9c9d65e606cd73c41b2ceadd5fa2cdf29cb',
        'sha256:7a987b5e2cbc9bafd7a80e92345efa35b331ccaa533aefe4722024485be57e4a',
        'sha256:7f7a7c0802daf0bed8e65744ef12480f14045f1d8c4048b80d35021448b83c07',
        'sha256:4b19ba4c81ffcb1fef8f2da8b45c47c9a0121f9531dcffabdd15af25c5b82dab',
        'sha256:161b3b2b85d075b069cb6b9a9dda26cf226c82ba4e7ee5e7946a2792cd76ecac',
        'sha256:273c82c0a0cf6c17d231f1be898ff74c6158f8036985cb3e1666b8f12c1b7895'
    ))
);
DELETE FROM fold_guard;
		`,
