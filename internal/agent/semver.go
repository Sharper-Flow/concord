...
func NegotiateSurfaceVersion(supportedRange string) (string, error) {
	...
	supported := []SemVer{{Major: 3, Minor: 0, Patch: 0}, {Major: 3, Minor: 1, Patch: 0}, {Major: 3, Minor: 2, Patch: 0}, {Major: 3, Minor: 3, Patch: 0}, {Major: 3, Minor: 4, Patch: 0}, {Major: 3, Minor: 5, Patch: 0}}
	var selected *SemVer
