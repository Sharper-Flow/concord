...
const ManifestDigest = "sha256:c6be78fb39cba9d44cd7fb40f0ba265d4d8b5f6f0865589cf66c72fa4027e6b9"
...
var ContractOperations = []ContractOperation{
	...
	{ID: "concord_work_epic.create", Tool: "concord_work_epic", Operation: "create", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("intent"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_create_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.add_entry", Tool: "concord_work_epic", Operation: "add_entry", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("relation"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_add_entry_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.remove_entry", Tool: "concord_work_epic", Operation: "remove_entry", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("relation"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_remove_entry_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.reorder_entry", Tool: "concord_work_epic", Operation: "reorder_entry", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("relation"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_reorder_entry_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.change_requiredness", Tool: "concord_work_epic", Operation: "change_requiredness", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("relation"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_change_requiredness_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.revise_narrative", Tool: "concord_work_epic", Operation: "revise_narrative", Kind: OperationKind("mutation"), QueryID: "", Capability: Capability("work_epic"), Consequence: OperationConsequence("intent"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_revise_narrative_input", ResultSchema: "mutation_result"},
	{ID: "concord_work_epic.entries", Tool: "concord_work_epic", Operation: "entries", Kind: OperationKind("read"), QueryID: "C21.EpicEntries", Capability: Capability("product_read"), Consequence: OperationConsequence("read"), Approval: ApprovalClass("none"), Availability: Availability("always"), InputSchema: "epic_entries_input", ResultSchema: "epic_entries_result"},
