...
| [`agent-lanes.v1.json`](./agent-lanes.v1.json) + [`agent-lanes.schema.json`](./agent-lanes.schema.json) | CD-0017 D1/D2 | Closed typed worker lanes with capability classes and evidence obligations. |
