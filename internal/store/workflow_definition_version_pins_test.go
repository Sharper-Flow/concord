...
func TestBuiltinDefinitionForRefResolvesTheLatestVersion(t *testing.T) {
	...
	cases := map[string]int64{
		"workflow.break_fix":          12,
		"workflow.implementation":     14,
		"workflow.generic_one_off":    8,
		"workflow.research":           8,
		"workflow.architecture_spike": 9,
		"workflow.ops_runbook":        10,
		"workflow.static_analysis":    7,
	}
