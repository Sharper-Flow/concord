...
def validate(manifest: dict) -> str:
    ...
    expected_operations = {"4.0.0": 47, "3.8.0": 47, "3.7.0": 47, "3.6.0": 47, "3.5.0": 46, "3.4.0": 43, "3.3.0": 40, "3.2.0": 39, "3.1.0": 38, "3.0.0": 32, "2.4.0": 25, "2.3.0": 23}.get(manifest.get("surface", {}).get("version"))
