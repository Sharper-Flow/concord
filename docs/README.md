...
| [`decisions/CD-0031-core-derived-session-boot.md`](./decisions/CD-0031-core-derived-session-boot.md) | **Accepted CD-0033:** launcher-started operator sessions receive a core-derived, versioned continuity packet before OpenCode starts; the launcher remains identity-only. |
