...
|---|---|---|---|
| **Initiative** | Product-scoped finite business/outcome context | Frame value/scope → order independent Domain-bound work → maintain shared active context → close only when required entries/conditions are terminal; no nested execution or architecture authority | CD-0041 and CD-0042: #196 directly replaces Epic with Initiative on the pre-go-live primary path; Initiative remains an ordinary work identity. |
