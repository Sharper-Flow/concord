...
| [`decisions/CD-0012-bind-stated-goals-to-delivered-outcomes.md`](./decisions/CD-0012-bind-stated-goals-to-delivered-outcomes.md) | **Proposed CD-0012, pending operator acceptance:** three-part outcome contract (premise, required end-state, candidate set) with separate revision authorities; end-state approved at planning beside the CD-0006 D10 spec mandate and verified at completion; strengthen-only delivery comparison; mid-execution discoveries forward-link rather than substitute. |
...
| [`research/R5-goal-to-outcome-binding.md`](./research/R5-goal-to-outcome-binding.md) | **Research for CD-0012:** measured goal drift, specification gaming, and goal misgeneralization evidence; mechanism and formalism surveys; four explicit insufficient-evidence findings; and the counter-evidence that shapes the contract. |
...
CD-0012 is **proposed and not yet binding**: it would give Priority 2's *intent fidelity*
and *no silent drift* attributes a mechanism by extending CD-0006 D10's approved-mandate
pattern from specs authorized for modification to end-state required for delivery.
