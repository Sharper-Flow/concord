...
func validateClaim(req ClaimRequest) error {
	if req.ContractVersion != "1.0.0" && req.ContractVersion != "2.0.0" && req.ContractVersion != "2.1.0" && req.ContractVersion != "2.2.0" && req.ContractVersion != "2.3.0" && req.ContractVersion != "2.4.0" && req.ContractVersion != "3.0.0" && req.ContractVersion != "3.1.0" && req.ContractVersion != "3.2.0" && req.ContractVersion != "3.3.0" {
...
func readStep(ctx context.Context, q interface {
	...
	if result.ContractVersion != "1.0.0" && result.ContractVersion != "2.0.0" && result.ContractVersion != "2.1.0" && result.ContractVersion != "2.2.0" && result.ContractVersion != "2.3.0" && result.ContractVersion != "2.4.0" && result.ContractVersion != "3.0.0" && result.ContractVersion != "3.1.0" && result.ContractVersion != "3.2.0" && result.ContractVersion != "3.3.0" {
