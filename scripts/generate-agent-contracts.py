...
def validate(manifest: dict) -> str:
    ...
    if len(operations) != 21 or len({o.get("id") for o in operations}) != 21:
        fail("manifest must contain exactly twenty-one unique operations")
