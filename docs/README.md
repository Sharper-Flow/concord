...
| [`knowledge/coverage/`](./knowledge/coverage/) | **Authorizing coverage record:** how each indexed law record is proved, by typed anchor rather than by repository path; an indexed record the shards omit is a validator finding (CD-0047). One shard per record; readers compose the record through `scripts/knowledge_index.py` (CD-0114). |
...
| [`concord-knowledge-index.md`](./concord-knowledge-index.md) + [`knowledge/`](./knowledge/) | Shard-primary durable decisions, specs, and lessons; strict blob proofs, scope modes, and typed research availability. The manifest is composed from `knowledge/manifest.json`, `knowledge/domain-registry.json`, and `knowledge/records/` (CD-0114). |
...
| [`agent-call-context-contract.md`](./agent-call-context-contract.md) | **Accepted TS5:** core-verified ambient scope, per-call capability authorization, operation-bound approvals, expected versions, and durable retry identity. |
...
| [`terminal-launcher-contract.md`](./terminal-launcher-contract.md) | **Superseded C18 contract:** the historical read-only Product launcher contract. |
| [`terminal-launcher-replacement-contract.md`](./terminal-launcher-replacement-contract.md) | **Accepted replacement contract under CD-0108:** Concord-first browse, session launch and resume, dense-pane interface, probe degradation, and a store-write-free boundary. |
...
| [`decisions/CD-0010-pre-readiness-development-authority.md`](./decisions/CD-0010-pre-readiness-development-authority.md) | **Accepted CD-0010:** historical pre-readiness authority, superseded only by CD-0089 at its self-hosting boundary. |
| [`decisions/CD-0089-concord-development-coordination.md`](./decisions/CD-0089-concord-development-coordination.md) | **Accepted CD-0089:** Concord owns its development workflow after issue #600 while GitHub retains planning and merge authority. |
...
| [`decisions/CD-0017-typed-workers-and-model-routing.md`](./decisions/CD-0017-typed-workers-and-model-routing.md) | **Accepted CD-0017, amended by CD-0058:** Concord-owned typed lane registry with closed packet/report envelopes, model-neutral capability classes, host-resolved model execution, recorded readback identity evidence, workflow-declared reviewer/model distinctness evaluated against readback, and a hard worker authority boundary preserving R1/CD-0013. |
...
| [`decisions/CD-0044-worker-evidence-caller-authentication.md`](./decisions/CD-0044-worker-evidence-caller-authentication.md) | **Accepted CD-0044:** worker-evidence CLI writes authenticate their caller with a signed `worker-evidence-v1` assertion bound to the exact attempt, lane, routing, and provenance identity; the nonce is consumed in the appending transaction; `worker_evidence` is client-policy authority; a terminal attempt refuses further evidence; the recorded actor is a verified client. |
...
| [`decisions/CD-0050-durable-acknowledgement.md`](./decisions/CD-0050-durable-acknowledgement.md) | **Accepted CD-0050:** acknowledged consequential operations — approvals, workflow dispatch and terminal transitions, cross-authority step claims, worker evidence — are durable across power loss via a TRUNCATE-checkpoint barrier under ordinary `synchronous=NORMAL`; ordinary writes are durable through the last boundary and the store stays consistent. |
| [`decisions/CD-0051-conformance-falsifier-quantity.md`](./decisions/CD-0051-conformance-falsifier-quantity.md) | **Accepted CD-0051:** the sustained conformance falsifier weighs commit-duration P99 — CD-0045's Concord-owned quantity — against the unchanged 100ms target; wall and writer-admission wait stay measured and diagnostic, correctness precedence and population authority are untouched, and scheduler-owned overshoot on a shared runner reports as `inconclusive` instead of a law-grade `fired`. |
| [`decisions/CD-0052-implements-fulfilment-semantics.md`](./decisions/CD-0052-implements-fulfilment-semantics.md) | **Accepted CD-0052:** `implements` is a directional, non-blocking, non-hierarchical, cycle-exempt many-to-one fulfilment link (work item fulfils a decision-kind item); display-only until a consumer defines its read surface in a citing record; removal is off the table while it sits in the closed vocabulary. |
| [`decisions/CD-0053-predecessor-strength-answers.md`](./decisions/CD-0053-predecessor-strength-answers.md) | **Accepted CD-0053, amended by CD-0082:** the three CD-0019 D3 questions are answered — the gated checkpoint lifecycle is absorbed into typed approval routes and consequence summaries, the agreement gate is preserved as the CD-0012 outcome contract enforced at completion, and wisdom capture is preserved as CD-0026 lesson publication into the git knowledge home. |
| [`decisions/CD-0055-repository-check-authority.md`](./decisions/CD-0055-repository-check-authority.md) | **Accepted CD-0055:** repository checks name one authority class — structural, real-tool, textual-guard, or warn-only; textual guards are narrow declared exceptions with documented false-positive shape and a named retirement end-state, heuristic judgment never blocks, and the store database boundary is enforced through the toolchain parser in `internal/store/boundary_test.go` (#302). |
| [`decisions/CD-0057-conformance-control-round.md`](./decisions/CD-0057-conformance-control-round.md) | **Accepted CD-0057:** the CD-0051 commit-duration falsifier requires both a paced-round majority above the 100ms P99 target and an above-target unpaced acceptance control; paced overshoot with a clean control is inconclusive, while correctness precedence, population authority, and diagnostic measurements remain unchanged (#341). |
...
| [`agent-lanes-contract.md`](./agent-lanes-contract.md) + [`agent-lanes.v1.json`](../contracts/agent-lanes.v1.json) + [`agent-lanes.schema.json`](../contracts/agent-lanes.schema.json) | **CD-0017 Phase 1:** generated closed lane registry, packet/report schemas, capability classes, budgets, lifecycle states, and evidence obligations. |
| [`decisions/CD-0054-routing-policy-host-authority.md`](./decisions/CD-0054-routing-policy-host-authority.md) | **Accepted CD-0054, superseded by CD-0058:** routing-policy authority is load-time host state — `CONCORD_ROUTING_POLICY` names a validated host policy (fail-closed when set but unreadable), the repo record ships as the default template, the lane registry goes model-neutral with load-time completeness validation, the adapter checks declared models against `opencode models`, and the CD-0044 evidence boundary binds the loaded digest unchanged. |
| [`decisions/CD-0058-no-model-routing.md`](./decisions/CD-0058-no-model-routing.md) | **Accepted CD-0058:** Concord performs no model resolution — the adapter omits `--model` from lane dispatch and OpenCode resolves the executing model from host configuration; `readback_model` is the sole model evidence feeding CD-0017 D6 distinctness; the routing-policy record, the `CONCORD_ROUTING_POLICY` host state, the load-time validation, and the five declared-side worker-attempt columns (`routing_policy_version`, `routing_policy_digest`, `resolved_model`, `resolution_role`, `fallback_reason`) are retired under a schema migration; CD-0017 D2's dispatch flag is dropped and D8/D9 retire. |
| [`decisions/CD-0082-migration-is-demand-driven.md`](./decisions/CD-0082-migration-is-demand-driven.md) | **Accepted CD-0082:** migration and correction are demand-driven and ad hoc; replacement readiness remains an evidence claim; CD-0006 D1-D2 and CD-0053 D4 cutover framing are amended without changing runtime behavior. |
| [`decisions/CD-0096-in-session-worktree-retargeting.md`](./decisions/CD-0096-in-session-worktree-retargeting.md) | **Accepted CD-0096, amends CD-0093 D2:** a running session may claim its current work item's canonical worktree and persistently retarget later Concord operations while the host process directory stays unchanged; tiered same-Project authority — read-only Inspect, exclusive-lease Verify, typed-transfer Take over, Destroy for merged terminal work; targets derive from Project and work identity, possession grants no Product authority, and continuity re-pins the target each turn. |
| [`decisions/CD-0097-bounded-parallel-predecessor-migration.md`](./decisions/CD-0097-bounded-parallel-predecessor-migration.md) | **Accepted CD-0097:** one Product at a time may migrate from the installed predecessor while both systems stay writable — the operator declares the mode, the predecessor stays installed, writable, and usable, and it remains the live authority for every migrated surface (specifications, active work, terminal history, wisdom, reflections) until the operator records cutover; items keep predecessor identity as provenance across repeated harvests, replay is idempotent with typed conflict refusals naming the owning source, knowledge curation records every drop, and `client-policy-expand` widens a trusted client policy by union so no existing grant is narrowed or dropped. |
| [`workflow-engine-contract.md`](./workflow-engine-contract.md) + [`workflow-engine.v1.json`](../scenarios/workflow-engine.v1.json) + [`workflow-definition.schema.json`](../contracts/workflow-definition.schema.json) | **CD-0013 implementation contract, amended by CD-0016:** registry digest pinning, V15/V22 projections and folds, closed event payloads, outcome comparison, completion gate, conditions, impact notices, context continuity, dispatch, family graphs, strict schemas, and all 56 conformance carriers. |
...
| [`product-data-model.md`](./product-data-model.md) | Product ownership, canonical Domain architecture, Initiative's secondary role, lifecycle stage, shared resources, and bounded Domain/work relations. |
...
is tagged and the accepted development-authority rules are in force.
