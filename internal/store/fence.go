...
func validateClaim(req ClaimRequest) error {
	if req.ContractVersion != "1.0.0" && req.ContractVersion != "2.0.0" && req.ContractVersion != "2.1.0" && req.ContractVersion != "2.2.0" && req.ContractVersion != "2.3.0" && req.ContractVersion != "2.4.0" && req.ContractVersion != "3.0.0" && req.ContractVersion != "3.1.0" && req.ContractVersion != "3.2.0" && req.ContractVersion != "3.3.0" && req.ContractVersion != "3.4.0" {
