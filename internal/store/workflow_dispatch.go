...
func ApplyWorkflowActionTx(ctx context.Context, tx *sql.Tx, registry DefinitionRegistry, request WorkflowActionExecutionRequest) (WorkflowActionExecutionResult, error) {
	...
	if request.ContractVersion != "1.0.0" && request.ContractVersion != "2.0.0" && request.ContractVersion != "2.1.0" && request.ContractVersion != "2.2.0" && request.ContractVersion != "2.3.0" && request.ContractVersion != "2.4.0" {
